#!/usr/bin/env python3
"""
compile_pristine_21page_preprint.py
===================================
Compiles the definitive, publication-grade 21-page bioRxiv preprint for HelixZero:
...
Outputs:
- D:/Helixx/helixzero_full_preprint_20pages.pdf (Precisely 21 Pages)
...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_header_footer(self, page_count):
        ...
        self.drawString(54, 34, "bioRxiv Preprint Submitted for Peer Review | Centre for Development of Advanced Computing (C-DAC)")
        self.setStrokeColor(colors.HexColor("#cbd5e1"))
        self.setLineWidth(0.5)
...
def build_pdf():
    print(f"Building pristine 21-page preprint to {OUTPUT_PDF}...")
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 1: TITLE, AUTHORS, ABSTRACT, INTRODUCTION PART 1
    # ═════════════════════════════════════════════════════════════════════════════
    ...
    story.append(HRFlowable(width="100%", thickness=1, color=colors.HexColor("#0f2942"), spaceAfter=6))
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 2: INTRODUCTION PART 2 & FIGURE 1
    # ═════════════════════════════════════════════════════════════════════════════
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 3: INTRODUCTION PART 3 & CONTRIBUTIONS
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 4: METHODS PART 1 (DATASETS & CMSIRNADB CENSUS)
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 5: METHODS PART 2 (NUCSLOT & FIGURE 2)
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 6: METHODS PART 3 (577-D FEATURES & FIGURE 4)
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 7: METHODS PART 4 (HIERARCHICAL ENGINE & GNN)
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 8: METHODS PART 5 (BIOPHYSICAL PENALTIES & BEAM SEARCH)
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 9: RESULTS PART 1 (EMPIRICAL BENCHMARKS TABLE IV)
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 10: RESULTS PART 2 (DICHOTOMY, IEEE MULTI-DOSE & FIGURE 3)
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 11: RESULTS PART 3 (ABLATION & FDA CASE STUDIES)
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 12: RESULTS PART 4 (TABLE VI & FIGURE 6 & BEAM SEARCH)
    # ═════════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
    # Table VI
    t6_data = [
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 13: RESULTS PART 5 (TABLE VII, TABLE VIII & FIGURE 7)
    # ═════════════════════════════════════════════════════
    story.append(PageBreak())
    # Table VII
    t7_data = [
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 14: RESULTS PART 6 (SHAP ATTRIBUTION & FIGURE 5)
    # ═════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 15: DISCUSSION PART 1 (BIOPHYSICS & METRICS)
    # ═════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 16: DISCUSSION PART 2 & PRECLINICAL TRANSLATION
    # ═════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    # ═════════════════════════════════════════════════════════════════════════════
    # PAGE 17: LIMITATIONS, CONCLUSION, AVAILABILITY, FUNDING
    # ═════════════════════════════════════════════════════
    story.append(PageBreak())
    ...
    for r in refs_p1:
        story.append(Paragraph(r, ParagraphStyle('RefStyle', fontName='Helvetica', fontSize=6.5, leading=8.5, textColor=colors.HexColor("#334155"), spaceAfter=1.8)))
    ...
    print(f"Successfully compiled pristine 21-page preprint: {OUTPUT_PDF}")
