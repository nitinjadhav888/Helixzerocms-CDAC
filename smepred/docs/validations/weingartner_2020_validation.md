...
|--------|-----------------|----------------|---------------|--------|
| **Naked** | None | 51.3 | +12.0 | High baseline penalty for lacking delivery mechanism. |
| **AS-5'** | Antisense 5' | 22.5 | +52.0 | **Fatal Penalty applied**, score drops to 0. Proves the model correctly identifies this as a dead drug. |
| **SS-5'** | Sense 5' only | 44.4 | +12.0 | Moderate penalty; recognized as active but suboptimal. |
| **Dual** | Sense 5' + 3' | 49.4 | 2.0 (Bonus) | **Bonus applied (-5.0)**, proving the model correctly identifies and rewards the superior dual-GalNAc architecture. |
